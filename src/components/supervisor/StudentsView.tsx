    ...
    <div className="space-y-4">
      {students.map((student) => {
        const completionRate = student.totalAssigned > 0
          ? Math.round((student.approvedCount / student.totalAssigned) * 100)
          : 0;
          ...
          <div key={student.studentId} className="bg-slate-50 rounded-xl p-6">
            ...
            <div className="grid grid-cols-5 gap-3 mb-4">
              ...
              <div className="bg-white rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-amber-600">{student.submittedToSupervisorCount}</p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-red-500">{student.sentBackCount}</p>
              </div>
              ...
              <div className="bg-white rounded-lg p-4">
                ...
                <p className="text-2xl font-bold text-green-600">{student.approvedCount}</p>
              </div>
            </div>
