...
export const UNBIS_THESAURUS: ThemeLevel1[] = [
  {
    ...
    subThemes: [
      ...
      { code: '01.07', name: 'Political Events and Issues' },
      { code: '01.08', name: 'Historical Periods' },
      { code: '01.09', name: 'General and National Law' },
      { code: '01.10', name: 'International Trade Law' },
      { code: '01.11', name: 'Law of the Sea' },
      { code: '01.12', name: 'Law of War' },
    ],
  },
  {
    code: '02',
    ...
    subThemes: [
      ...
      { code: '02.10', name: 'Development Finance' },
      { code: '02.11', name: 'Banking and Investment' },
      { code: '02.12', name: 'Statistics' },
      { code: '02.13', name: 'Taxation' },
      { code: '02.14', name: 'Transnational Corporations' },
      { code: '02.15', name: 'Consumers and Cooperatives' },
    ],
  },
  {
    code: '03',
  ...
  },
  {
    ...
    subThemes: [
      ...
      { code: '08.04', name: 'Special Groups' },
      { code: '08.05', name: 'National Groups' },
    ],
  },
  {
    code: '09',
  ...
  },
  {
    ...
    subThemes: [
      ...
      { code: '14.06', name: 'Crime and Criminal Justice' },
      { code: '14.07', name: 'Human Rights' },
      { code: '14.08', name: 'Psychology' },
      { code: '14.09', name: 'Social Development' },
      { code: '14.10', name: 'Social Science Disciplines and Methodologies' },
      { code: '14.11', name: 'Welfare and Social Services' },
    ],
  },
  {
    code: '15',
  ...
  },
  {
    ...
    subThemes: [
      ...
      { code: '17.06', name: 'Oceania' },
      { code: '17.07', name: 'Oceans and Seas' },
    ],
  },
  {
    code: '18',
    name: 'Organizational Questions',
    subThemes: [
      { code: '18.01', name: 'International Civil Service' },
      { code: '18.02', name: 'Organizational Structure' },
      { code: '18.03', name: 'Administration' },
      { code: '18.04', name: 'Financing' },
      { code: '18.05', name: 'Programme Planning' },
      { code: '18.06', name: 'Operational Activities' },
      { code: '18.07', name: 'Conferences' },
      { code: '18.08', name: 'Documents' },
      { code: '18.09', name: 'Recommendations' },
    ],
  },
];
